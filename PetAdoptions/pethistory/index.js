...
exports.handler = async (event, context) => {
    console.log('Processing adoption history messages:', JSON.stringify(event, null, 2));
    ...
    console.log(`Processed ${results.length} messages successfully, ${batchItemFailures.length} failed`);
...
async function writeAdoptionHistoryToDatabase(adoptionData) {
    ...
    try {
        ...
        console.log(`Successfully inserted adoption history record: ${adoptionData.transactionId}, rows affected: ${result.rowCount}`);
