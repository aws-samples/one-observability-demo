...
func (m *mockRepository) GetConnectionString(ctx context.Context) (string, error) {
	...
	return "postgres://user:pass@localhost:5432/testdb?sslmode=disable", nil //pragma: allowlist secret
}
...
func TestDatabaseConfigService(t *testing.T) {
	...
	if dbSvc.cfg.RDSSecretArn != "test-secret-arn" { //pragma: allowlist secret
...
func TestDatabaseConnectionExhaustion(t *testing.T) {
	...
	mockConnStr := "postgres://user:pass@nonexistent:5432/testdb?sslmode=disable" //pragma: allowlist secret
...
func TestDegradationScenarios(t *testing.T) {
	...
	t.Run("DatabaseConnectionDegradation", func(t *testing.T) {
		repo := &mockRepository{
			connectionString: "postgres://user:pass@nonexistent:5432/testdb?sslmode=disable", //pragma: allowlist secret
		}
