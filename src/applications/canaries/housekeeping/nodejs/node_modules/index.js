//Update to use the new petsite URL from SSM
...
const recordedScript = async function () {
    ...
    if (!ssmParameterName) {
        log.error('SSM parameter name not set');
    ...
    try {
        ...
        log.info('SSM access failed');
        throw new Error('SSM access failed: ' + error.message);
    }
    ...
    await page.goto(petsiteUrl + "?userId=user17211", {waitUntil: 'domcontentloaded', timeout: 60000})
  })
