...
export class PetFoodECSService extends EcsService {
    constructor(scope: Construct, id: string, properties: PetFoodProperties) {
        const environmentVariables = {
            ...
            DDB_INTERFACE_ENDPOINT_PARAMETER_NAME: SSM_PARAMETER_NAMES.DDB_INTERFACE_ENDPOINT_NAME,
            S3_INTERFACE_ENDPOINT_PARAMETER_NAME: SSM_PARAMETER_NAMES.S3_INTERFACE_ENDPOINT_NAME,
        };
        super(scope, id, {
            ...properties,
